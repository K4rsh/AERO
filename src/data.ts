export const members = [
  {
    ...
    headshot: '/assets/Headshots/DrGillianSheppard.png',
    about:
  ...
  {
    name: 'Dr. Margo Wilson BSc MD CCFP(EM)',
    headshot: '/assets/Headshots/DrMargoWilson.jpg',
    about:
    ...
    publications: [
      ...
      '2021	Wilson, M. M., Devasahayam, A. J., Pollock, N. J., Dubrowski, A., and Renouf, T. (2021). Rural family physician perspectives on communication with urban specialists: A qualitative study. BMJ Open, 11(5), e043470',
    ],
  },
  {
    name: 'Dr. Kayla Furlong MD MSc CCFP (EM)',

    headshot: '/assets/Headshots/DrKaylaFurlong.jpg',
